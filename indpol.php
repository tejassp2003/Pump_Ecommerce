    ...
    <div class="productmain">
        ...
        <dic class="container">
            <form action="/indpol.php">
                <div class="forminput">
                    <h5>ನೀರಿನ ಅವಶ್ಯಕತೆ ದಿನಕ್ಕೆ ಲೀಟರ್ಗಳಲ್ಲಿ <br>Drainage or Muddy Water to be Pumped (in LPM) </h5> &emsp;
                    <input type="number" placeholder="LPM" class="" >
                </div>
                
                <div class="forminput">
                    <h5>ಒಟ್ಟು ಎಷ್ಟು ಎತ್ತರಕ್ಕೆ ನೀರನ್ನು ಎತ್ತಬೇಕು ಮೀಟರ್ಗಳಲ್ಲಿ <br>Height to be pumped(in metres) </h5> &emsp;
