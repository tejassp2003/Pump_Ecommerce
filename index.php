      ...
      <div class="container">
        <div class="categoryinfo">
          ...
          <div class="list-group">
            <a href="soborewell.php" class="list-group-item" lang="en">
              Sump and Open Borewell
            </a>
            <a href="soborewell.php" class="list-group-item" lang="ka">
              ತೊಟ್ಟಿ ಮತ್ತು ತೆರೆದ ಭಾವಿ
            </a>
            <a href="dcborewell.php" class="list-group-item" lang="en">
              Bore Well
            </a>
            <a href="dcborewell.php" class="list-group-item" lang="ka">
              ಕೊಳವೆ ಭಾವಿ
            </a>
          </div>
        </div>
        <div class="categoryinfo">
          ...
          <div class="list-group">
            ...
            <a href="aowell.php" class="list-group-item" lang="ka">
              ತೆರೆದ ಭಾವಿ
            </a>
            <a href="agriborewell.php" class="list-group-item" lang="en">
              Bore Well
            </a>
            <a href="agriborewell.php" class="list-group-item" lang="ka">
              ಕೊಳವೆ ಭಾವಿ
            </a>
            <a href="acorrp.php" class="list-group-item" lang="en">
              Canal or River
            </a>
            <a href="acorrp.php" class="list-group-item" lang="ka">
              ಕಾಲುವೆ ಅಥವಾ ನದಿ
            </a>
            <a href="alip.php" class="list-group-item" lang="en">
              Lift Irrigation
            </a>
        ...
        <div class="categoryinfo">
          ...
          <div class="list-group">
            ...
            <a href="indpol.php" class="list-group-item" lang="ka">
